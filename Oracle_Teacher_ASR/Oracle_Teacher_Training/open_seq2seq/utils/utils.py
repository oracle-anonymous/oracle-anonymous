...
def get_base_config(args):
  ...
  parser.add_argument("--mode", help="Could be \"train\", \"eval\", "
                           "\"train_eval\" or \"infer\"")
  ...
  parser.add_argument('--enable_logs', dest='enable_logs', action='store_true', help='whether to log output, git info, cmd args, etc.')
