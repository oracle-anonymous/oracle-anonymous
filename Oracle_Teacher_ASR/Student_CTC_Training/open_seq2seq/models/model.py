...
class Model:
  ...
  def compile(self, force_var_reuse=False, checkpoint=None):
    ...
    if self._mode == "train":
      ...
      #   if 'w2l' not in var_name: #if 'ctc' in var_name or 'teacher' in var_name: #or 'teacher01' in      var_name or 'teacher02' in var_name or 'teacher10' in var_name or 'teacher11' in var_name or 'teac     her12' in var_name: #'ctc'in var_name
