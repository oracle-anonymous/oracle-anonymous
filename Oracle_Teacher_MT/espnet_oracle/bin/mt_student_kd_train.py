...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument(
        "--dict", help="Dictionary for source/target languages"
    )
    ...
    parser.add_argument(
        "--teacher_model_knowledge_dir", type=str, help="Teacher_model"
    )
    # loss related
    parser.add_argument(
...
def main(cmd_args):
    ...
    model_module = "espnet.nets.pytorch_backend.e2e_mt_transformer_student_kd:E2E"
    ...
    if args.backend == "pytorch":
        from espnet.mt.pytorch_backend.mt_kd import train
