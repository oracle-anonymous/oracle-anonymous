...
train_config=conf/tuning/oracle.yaml
...
#    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
    CUDA_VISIBLE_DEVICES=0 mt_oracle_train.py \
    --config ${train_config} \
    --ngpu ${ngpu} \
    --backend ${backend} \
...
#        ${decode_cmd} JOB=1:${nj} ${expdir}/${decode_dir}/log/decode.JOB.log \
    ...
    --backend ${backend} \
    --batchsize 0 \
    --trans-json ${dumpdir}/${train_set}/data.json \
    --model ${expdir}/results/snapshot.ep.50
fi
